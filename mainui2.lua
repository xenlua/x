...
Avantrix["18"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.978, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(192, 132, 252))};
...
Avantrix["55"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(0, 162, 255))};


-- Avantrix.Templates.Button.Frame.UIGradient
Avantrix["56"] = Instance.new("UIGradient", Avantrix["4e"]);
Avantrix["56"]["Enabled"] = false;
Avantrix["56"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(0, 162, 255))};
...
Avantrix["73"]["Color"] = ColorSequence.new{ ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)), ColorSequenceKeypoint.new(1.000, Color3.fromRGB(192, 132, 252)) };
