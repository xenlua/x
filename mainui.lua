...
Avantrix["18"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(91, 192, 255)),ColorSequenceKeypoint.new(0.978, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(91, 192, 255))};
...
Avantrix["54"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(0, 162, 255))};


-- Avantrix.Templates.Button.Frame.UIGradient
Avantrix["55"] = Instance.new("UIGradient", Avantrix["4e"]);
Avantrix["55"]["Enabled"] = false;
Avantrix["55"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(91, 192, 255)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(91, 192, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(0, 162, 255))};


-- Avantrix.Templates.Button.Frame.UIGradient
Avantrix["56"] = Instance.new("UIGradient", Avantrix["4e"]);
Avantrix["56"]["Enabled"] = false;
Avantrix["56"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(91, 192, 255)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(0, 162, 255)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(0, 162, 255))};
...
Avantrix["73"]["Color"] = ColorSequence.new{ ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)), ColorSequenceKeypoint.new(1.000, Color3.fromRGB(91, 192, 255)) };
...
Avantrix["7b"]["Color"] = ColorSequence.new{
    ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 162, 255)),
    ColorSequenceKeypoint.new(1.000, Color3.fromRGB(91, 192, 255))
};
...
Avantrix["93"]["Color"] = Color3.fromRGB(0, 162, 255);
...
Avantrix["e3"]["BackgroundColor3"] = Color3.fromRGB(91, 192, 255);
			...
			function Window:Tab(data)
				...
				function Tab:Button(data)
					...
					newButton.MouseEnter:Connect(function()
						if not ButtonData.Locked then
							Tween(newButton.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Paragraph(data)
					local Paragraph = {
						Title = data.Title,
						Desc = data.Desc,
						RichText = data.RichText ~= false, -- Default nyala (true) biar bisa pake warna
					}
				...
				function Tab:Toggle(data)
					...
					newToggle.Title.Fill.MouseEnter:Connect(function()
						if not Toggle.Locked then
							Tween(newToggle.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Slider(data)
					...
					Trigger.MouseEnter:Connect(function()
						...
						if not Slider.Locked then
							Tween(newSlider.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Input(data)
					...
					newInput.BoxFrame.Frame.TextBox.MouseEnter:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Dropdown(data)
					...
					local function SelectValue(multi, newvalue)
						if not multi then
							...
							Tween(targetButton.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
							...
							Tween(targetbuttonSearch.UIStroke, {Color = Color3.fromRGB(0, 162, 255)}, TweenConfigs.Global)
						...
						if not Dropdown.Multi then
							...
							for _, buttonName in buttonList do
								...
								if selected == buttonName then
									...
									newDropdownButton.UIStroke.Color = Color3.fromRGB(0, 162, 255)
									...
									newDropdownButtonSearch.UIStroke.Color = Color3.fromRGB(0, 162, 255)
					...
					function Dropdown:Select(newval)
                        if Dropdown.Multi then
                            -- Reset dulu semua yang lagi nyala biar gak bentrok (Toggle OFF)
                            local currentlySelected = {}
                            for _, v in ipairs(selected) do table.insert(currentlySelected, v) end
                            SelectValue(true, currentlySelected)
                            
                            -- Baru nyalain yang sesuai Config (Toggle ON)
                            local targetValues = type(newval) == "table" and newval or {newval}
                            SelectValue(true, targetValues)
                        else
                            SelectValue(false, newval)
                        end
